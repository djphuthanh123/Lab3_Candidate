...
public class CandidateMng {
    ...
    public static ArrayList<Candidates> getListStudentByType(int type) {
        ArrayList<Candidates> getListStudentByType = new ArrayList<>();
        for (Candidates cd : candidatesList) {
            if (type == cd.getTypeCandidate()) {
                getListStudentByType.add(cd);
            }

        }
        return getListStudentByType;
    }
    ...
    public void update() {
        int type = Validation.inputInt("Select Type do u want Update ", 0, 2);
    ...
    public void generationCandidate() {
        ...
        candidatesList.add(new Experience(10, "Font-end", "45", "long", "le", 1999, "Da Nang", "0905563888", "nnnl1999@gmail.com", 0));
